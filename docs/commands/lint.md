...
homingo lint --gen-model gpt-4o-mini
...
::: tip
The generation model handles the highest-volume operation (producing adversarial prompts and test data). Auto-deriving a cheaper generation model typically reduces total API cost by 80–90% compared to using the primary model for everything.
:::
