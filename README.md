...
# Generate a capability map for your fleet
homingo map
...
| Flag | Description |
|------|-------------|
| `--mode <pair\|fleet>` | Test pair boundaries or route prompts against the full manifest |
...
Capability-map report for your fleet. Runs locally with no API calls.

```bash
homingo map --skills-dir ./skills
```

Outputs capability clusters, nearest-neighbor profiles, merge candidates, overlap hubs, and handbook-style JSON/HTML artifacts.
...
Homingo is complementary to recent work on ecosystem-scale skill orchestration and learned routing:
...
Those papers focus more on runtime retrieval, orchestration, and skill-transfer policies. Homingo focuses on offline skill-fleet governance: detecting routing drift, measuring ambiguity, and repairing descriptions through rewrites, merge recommendations, and sharding.

See the docs page on [Research Context](https://homingo.github.io/concepts/research-context) for the fuller comparison.
